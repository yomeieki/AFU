...
- 新错误码（4226x 段，批次一用了 42260–42262）：`42263` 有取件预约请先取消、`42264` 有活跃预约不能手填发货、`42265` 已有取件预约、`42266` 有待处理的取消申请、`42267` 预约状态不允许该操作（含 UNKNOWN 待核对）、`42268` 快递100 请求超时状态未变、`42269` 时段不合规、`42270` 快递100 下单失败（原话）。
